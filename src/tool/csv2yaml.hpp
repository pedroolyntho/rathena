...
void init_random_option_constants() {
	...
	export_constant2("RDMOPT_HP_DRAIN_RATE", 255);
	export_constant2("RDMOPT_BLEEDING_RATE", 256);
	export_constant2("RDMOPT_SILENCE_RATE", 257);
	export_constant2("RDMOPT_STUN_RATE", 258);
	export_constant2("RDMOPT_FEAR_RATE", 259);
	export_constant2("RDMOPT_SP_DRAIN_RATE", 260);
	export_constant2("RDMOPT_SP_ON_MAGIC_KILL", 261);
	export_constant2("RDMOPT_SP_ON_KILL", 262);
	export_constant2("RDMOPT_HP_ON_MAGIC_KILL", 263);
	export_constant2("RDMOPT_HP_ON_KILL", 264);
	export_constant2("RDMOPT_BLIND_RATE", 265);
	export_constant2("RDMOPT_SLEEP_RATE", 266);
	export_constant2("RDMOPT_BURNING_RATE", 267);
	export_constant2("RDMOPT_STONE_RATE", 268);
