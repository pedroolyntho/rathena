...
//Novice And 1-1 Jobs
	...
	MAPID_SUMMONER,
	MAPID_SUMMER2,
	MAPID_BARDDANCER = 0x018, //not sure what it does but 0x018 is avoiding etc tab random skills
	MAPID_KNIGHT = 0x019,
	MAPID_SAGE = 0x020,
	MAPID_SOUL_LINKER = 0x021,
//2-1 Jobs
	MAPID_SUPER_NOVICE = JOBL_2_1|MAPID_NOVICE,
	MAPID_LORD_KNIGHT = JOBL_2_1|MAPID_SWORDMAN, //path of tyr
	MAPID_WIZARD = JOBL_2_1|MAPID_MAGE, //the storm
	MAPID_ASSASSIN = JOBL_2_1|MAPID_ARCHER, //stormheart
	MAPID_PRIEST = JOBL_2_1|MAPID_ACOLYTE, //arctic domain
	MAPID_CLOWNGYPSY = JOBL_2_1|MAPID_BARDDANCER, //College of the Hearth
	MAPID_PALADIN = JOBL_2_1|MAPID_KNIGHT, //oath of the dawn
	MAPID_STAR_GLADIATOR = JOBL_2_1|MAPID_SAGE, //tri-caster
	MAPID_REBELLION = JOBL_2_1|MAPID_GUNSLINGER,
	MAPID_DEATH_KNIGHT = JOBL_2_1|MAPID_GANGSI,
	MAPID_KAGEROUOBORO,
	MAPID_BLACKSMITH,
//2-2 Jobs
	MAPID_ASSASSIN_CROSS = JOBL_2_2|MAPID_SWORDMAN, //frost wolf
	MAPID_PROFESSOR = JOBL_2_2|MAPID_MAGE, //the fiend
	MAPID_HUNTER = JOBL_2_2|MAPID_ARCHER, // frozen prowler
	MAPID_MONK = JOBL_2_2|MAPID_ACOLYTE, //thunder domain
	MAPID_MINSTRELWANDERER = JOBL_2_2|MAPID_BARDDANCER, //light bearer
	MAPID_CRUSADER = JOBL_2_2|MAPID_KNIGHT, //oath of storms
	MAPID_HIGH_WIZARD = JOBL_2_2|MAPID_SAGE, //rune mage
	MAPID_ALCHEMIST,
	MAPID_ROGUE,
...
//3-1 Jobs
	...
	MAPID_STAR_EMPEROR,
//3-2 Jobs
	MAPID_RUNE_KNIGHT,// = JOBL_UPPER|MAPID_CRUSADER,
	MAPID_SORCERER,
	MAPID_SURA,
	MAPID_GENETIC,
	MAPID_SHADOW_CHASER,
//Trans 3-1 Jobs
	...
	MAPID_WARLOCK_T = JOBL_THIRD|MAPID_HIGH_WIZARD,
	MAPID_RANGER_T,
	MAPID_ARCH_BISHOP_T,
	MAPID_MECHANIC_T,
