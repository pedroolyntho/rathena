...
#define SCRIPT_CONSTANTS_HPP
	...
	//Custom Jobs
	export_constant(JOB_BARBARIAN);
	export_constant(JOB_CLERIC);
	...
	//Custom Job
	export_constant2("EAJ_BARBARIAN", MAPID_BARBARIAN);
	export_constant2("EAJ_CLERIC", MAPID_CLERIC);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_HABIB_BEGINNER_LV10);
